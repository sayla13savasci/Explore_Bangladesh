...
<?php
		...
		$sql="SELECT * FROM hotels WHERE property_type= '$hotel_aminities'";
		...
		$sql ="select * from hotels where property_type='$hotel_aminities' limit $starting_limit_number_perpage,2";
		...
		$myOutput = '<div class="container">
						...
						$output .=	'<div class="col-md-5 detail" style="padding-left:70px;">
							<strong>'.$row['hotel_name'].'</strong><br>
										<a href="hotels_plce.php?hotel_place='.$row["hotel_place"].'">'.$row['hotel_place'].'</a>
