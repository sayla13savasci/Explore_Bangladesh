...
<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="insert into tour_guest_order(fname,lname,email,phone,address) values
			...
			if(isset($_POST['btn1']))
	{
		...
		if(mysqli_num_rows($result)){
			$_SESSION['id']=$row['user_id'];
				header("Location:final_tour_order.php?tour_id=".$tour_id);
		}
	   	else{
...
<!---personal information for order column start -->
      ...
      <div class="w3-row" style="height: 50px;background-color:#ff8c00;margin-top: 110px;">
      ...
      <div class="w3-row w3-card-4" style="height: 250px;margin-top:20px;width: 650px;background-color: white">
          <div style="background-color:#009999;height: 55px;margin-top: -10px;">
...
<!--summary column start-->
  <div class="w3-col s4  w3-center w3-card-4" style="background-color: white;height: 800px; margin-left: 30px;">
    ...
    <div class="w3-row w3-white">
      ...
      <?php 
        ...
        $sql2="SELECT * FROM  order_tour where email='$ee'";
      ...
      <hr>
      <label for="day" style="font-size: 17px;font-weight: 20;">Day :</label><?php echo $day; ?>
      <hr>
      <label for="night" style="font-size: 17px;font-weight:20;">Night :</label><?php echo $night; ?>
      <hr>
      <label for="date" style="font-size: 17px;font-weight:20;">Date :</label><?php echo $date; ?>
      <hr>
      <label for="child" style="font-size: 17px;font-weight:20;">Child :</label><?php echo $child; ?>
      <hr>
      <label for="adult" style="font-size: 17px;font-weight:20;">Adult:</label><?php echo $adult; ?>
      <hr>
       <label for="child_price" style="font-size: 17px;font-weight:20;">Price For Child:</label><?php echo $child_price; ?>
      <hr>
       <label for="adult_price" style="font-size: 17px;font-weight:20;">Price For Adult:</label><?php echo $adult_price; ?>    
    </div>
  </div>
  <!--summary column end-->
...
<!---personal information for order column start -->
  	<div class="w3-col s7 w3-white w3-card-4" style="height: 500px;width: 720px;">
    	...
    	<div class="w3-row" style="background-color:#ffffff;height: 80px;">
    		<div class="w3-col  w3-hover-opacity" style="height: 60px;width:500px; background-color:#372f6a; margin-top: 20px;margin-left: 110px;">
...
-->
      ...
      <!--terms and policy row start-->
      <div class="w3-row" style="height: 50px;background-color:#ff8c00;margin-top: 100px;">
      ...
      <div class="w3-row w3-card-4" style="height: 250px;margin-top:30px;width: 720px;background-color: white">
          <div style="background-color:#009999;height: 55px;margin-top: -10px;">
            <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">Terms And Policy</h4>
...
<!--summary column start-->
  <div class="w3-col w3-center w3-card-4" style="background-color:white;height: 800px;width:350px; margin-left: 40px;">
    <div style="background-color:#ffa333;height: 55px;margin-top: -10px;">
      <h4 style="text-align: center;margin-bottom: 5px;color: #f8f8ff; font-size: 25px;">&#9989;Booking Summary</h4>
    </div>
...
if(isset($_SESSION['id']))
{
 ...
 <!--booking div start -->
	<div class="w3-row" style="width: 800px;margin-top: -100px;">
