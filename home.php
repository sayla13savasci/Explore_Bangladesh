...
<div class="w3-row" style="margin-top:300px">
	  ...
	  <div class="des" style="margin-top:70px;margin-bottom:30px"> <h3 style="font-weight:600; margin-left:40px;">Popular Tours: </h3>  </div>
		<?php
				//$con=new mysqli("localhost","root","", "travelandtour");
...
<div  class="w3-row" style="margin-top:60px;margin-bottom:100px;">
	  ...
	  <h4 class="des" style="margin-top:30px;"> <h3 style="font-weight:600; margin-left:40px;">Popular Hotels: </h4>  
		<?php
