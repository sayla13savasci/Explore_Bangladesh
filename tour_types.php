...
<div class="row" style="margin-top: 90px;">
  <div class="col-md-4" style="width: 350px;height: 600px;margin-left:100px;">
    ...
    <div class="tour-type w3-card-2 w3-hover-opacity" style="height: 300px;">
      <h4 style="margin-top: 50px;text-align: center; background-color: #009999;color: white;height:30px;">Tour Types</h4>
  ...
  <div class="col-md-6" style="width:800px;"  id="pagination_data">
